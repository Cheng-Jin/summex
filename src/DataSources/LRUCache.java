...
public class LRUCache<K, V> {
	...
	public LRUCache(int cacheSize) {
		...
		map = new LinkedHashMap<K, V>(hashtableCapacity, hashTableLoadFactor, true) {
			...
			@Override
			protected boolean removeEldestEntry(Map.Entry<K, V> eldest) {  //超出cacheSize就开始删除
	...
	/**
	 * Returns a <code>boolean</code> that wheather cache contains a entry
	 * 
	 * @return a <code>boolean</code> that wheather cache contains a entry
	 */
